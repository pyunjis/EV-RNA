...
SAMPLES, = glob_wildcards("samples/raw/191101/{sample}_R1.fastq.gz")
...
rule all:
    input:
        ...
        expand("samples/fastqscreen/191101/{sample}/{sample}_{ext}_screen.{fastqscreen_ext}", sample=SAMPLES, ext=ext, fastqscreen_ext=fastqscreen_ext),
