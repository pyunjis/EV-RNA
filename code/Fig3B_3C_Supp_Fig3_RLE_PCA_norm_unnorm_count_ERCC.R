# Figure 3B RLE plot
# Figure 3C PCA plot
# Supp Figure 3 unnorm vs norm counts and ERCC
...
pdf("./Figures/Supp_Figure_3A_Unnorm_RLE.pdf", width = 5, height =5)
...
# plotRLE with new order
pdf("./Figures/Supp_Figure_3B_Norm_RLE.pdf", width = 8, height =5)
...
# plotRLE with new order
pdf("./Figures/Supp_Figure_3C_Unnorm_ERCC.pdf", width = 5, height =5)
plotRLE(set2, col=colors[d], legend=TRUE, outline=FALSE, ylim=c(-3, 3), ylab ="RLE",
        cex.axis =1.3, cex.lab =1.5, cex.main =2, whisklty = 0, staplelty = 0)
dev.off()

# plotRLE with new order
pdf("./Figures/Supp_Figure_3D_Norm_ERCC.pdf", width = 5, height =5)
