...
# Supp Figure 2A, 2B, and 2C %unique reads, exon fraction, and intron fraciton 
...
# Get mean, min, and maxium of intron fraction
...
star.df$Condition <- factor(star.df$Condition, levels=c("HD", "LV", "LG", "MM"))
star_tidy <- star.df %>%
  arrange(Condition)
...
pdf("Figures/Supp_Figure_2A_percent_unique_reads.pdf", width =9, height = 3)
print(p5)
dev.off()


pdf("Figures/Supp_Figure_2B_Exon_Fraction.pdf", width =9, height = 3)
print(p3)
dev.off()


pdf("Figures/Supp_Figure_2C_Intron_Fraction.pdf", width =9, height = 3)
print(p2)
dev.off()
